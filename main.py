...
class MiApp(QtWidgets.QMainWindow):
	...
	def insert_productos(self):
		numero = self.ui.numeroA.text() 
		nombre = self.ui.nombreA.text()
		unidad = self.ui.unidadA.text()
		puesto = self.ui.puestoA.text()
		

		self.datosTotal.inserta_producto(numero, nombre, unidad, puesto)
		self.ui.numeroA.clear()
		self.ui.nombreA.clear()
		self.ui.unidadA.clear()
		self.ui.puestoA.clear()
	...
	def modificar_productos(self):
		...
		if nombreXX != None:
			...
			numeroM = self.ui.numero_actualizar.text() 
			nombreM = self.ui.nombre_actualizar.text()
			unidadM = self.ui.unidad_actualizar.text()
			puestoM = self.ui.puesto_actualizar.text()
			
			act = self.datosTotal.actualiza_productos(numeroM, nombreM , unidadM, puestoM)
			if act == 1:
				self.ui.id_buscar.setText("ACTUALIZADO")				
				self.ui.numero_actualizar.clear()
				self.ui.nombre_actualizar.clear()
				self.ui.unidad_actualizar.clear()
				self.ui.puesto_actualizar.clear()
	...
	def buscar_producto(self):
		numero_producto = self.ui.numeroB.text()
	...
	def eliminar_producto(self):
		eliminar = self.ui.numero_borrar.text()
